...
class BlocksModule {
	...
	applyPatches() {
		...
		fluxloaderAPI.setPatch("js/515.bundle.js", "corelib:solidMovementTweaks", {
			type: "regex",
			pattern: `/F=\(0,o\.Ol\)\(g\);([\s\S]*?)if\(p\|\|M\|\|\(0,o\.W\)\(g,a\.vZ\.Block\)\)([\s\S]*?)if\(\(!g\|\|M\|\|!S\(e,t,g\)\)&&!\(0,f\.v\)\(e,t,g\)\)/`,
			replace: `F=(0,o.Ol)(g),blockBelow=(0,corelib.utils.getStructureAtPos)(t.x,t.y+1);$1if((blockBelow&&(0,corelib.simulation.doBlockRecipes)(t.x,t.y,t,blockBelow,g))||p||M||(0,o.W)(g,a.vZ.Block))$2if((!g||M||!S(e,t,g))&&!(0,corelib.simulation.doBlockRecipes)(t.x,t.y,t,(0,corelib.utils.getStructureAtPos)(t.x,t.y+1),g))`,
		}); /*
